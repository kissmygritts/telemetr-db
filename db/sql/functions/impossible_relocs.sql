...
impossible relocation. An impossible relocation is a spike that is
impossible for the animal to have taken. Often these relocations are
extremely obvious from visual inspection. 
*/
CREATE OR REPLACE FUNCTION impossible_relocs()
RETURNS bigint AS $$
